 ...
 * @since 8/17/2017
 */
public class PunishmentRemovalSuccessPacketOut extends WritablePacket {
	...
	public PunishmentRemovalSuccessPacketOut(byte worldId, Punishment punishment, String message) {
		super(PUNISHMENT_REMOVAL_SUCCESS_ALERT_PACKET_ID);
