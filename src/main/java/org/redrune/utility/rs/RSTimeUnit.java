...
public enum RSTimeUnit {
	TICKS {
		...
		public long convert(long d, RSTimeUnit u) {
	 ...
	 */
	public long convert(long sourceDuration, RSTimeUnit sourceUnit) {
		throw new AbstractMethodError();
	}
	
	/**
	 * Equivalent to
	 * {@link #convert(long, RSTimeUnit) NANOSECONDS.convert(duration, this)}.
	 *
	 * @param duration
	 * 		the duration
	...
	/**
	 * Equivalent to
	 * {@link #convert(long, RSTimeUnit) MICROSECONDS.convert(duration, this)}.
	 *
	 * @param duration
	 * 		the duration
	 * @return the converted duration, or {@code Long.MIN_VALUE} if conversion would negatively overflow, or {@code
	...
	/**
	 * Equivalent to
	 * {@link #convert(long, RSTimeUnit) SECONDS.convert(duration, this)}.
	 *
	 * @param duration
	 * 		the duration
	 * @return the converted duration, or {@code Long.MIN_VALUE} if conversion would negatively overflow, or {@code
	...
	/**
	 * Equivalent to
	 * {@link #convert(long, RSTimeUnit) MINUTES.convert(duration, this)}.
	 *
	 * @param duration
	 * 		the duration
	 * @return the converted duration, or {@code Long.MIN_VALUE} if conversion would negatively overflow, or {@code
	...
	/**
	 * Equivalent to
	 * {@link #convert(long, RSTimeUnit) HOURS.convert(duration, this)}.
	 *
	 * @param duration
	 * 		the duration
	 * @return the converted duration, or {@code Long.MIN_VALUE} if conversion would negatively overflow, or {@code
	...
	/**
	 * Equivalent to
	 * {@link #convert(long, RSTimeUnit) DAYS.convert(duration, this)}.
	 *
	 * @param duration
	 * 		the duration
	...
	/**
	 * Equivalent to
	 * {@link #convert(long, RSTimeUnit) MILLISECONDS.convert(duration, this)}.
	 *
	 * @param duration
	 * 		the duration
	 * @return the converted duration, or {@code Long.MIN_VALUE} if conversion would negatively overflow, or {@code
