 ...
 * @since 8/15/2017
 */
public class FriendStatusChangePacketOut extends WritablePacket {
	...
	public FriendStatusChangePacketOut(String name, byte status, byte worldId, boolean online, boolean lobby) {
		super(FRIEND_STATUS_CHANGE_RECEIVE_PACKET_ID);
		this.name = name;
		this.status = status;
